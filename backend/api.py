...
@app.get("/integrations/calendar/status", response_model=CalendarStatusResponse)
def calendar_status():
    """Get Google Calendar connection status."""
    try:
        from .integrations.google_calendar import get_calendar_status
...
@app.get("/integrations/calendar/auth-url", response_model=CalendarAuthUrlResponse)
...
@app.get("/integrations/calendar/auth", response_model=CalendarStatusResponse)
...
@app.post("/integrations/calendar/disconnect", response_model=CalendarStatusResponse)
def calendar_disconnect():
    """Disconnect Google Calendar integration."""
    try:
        from .integrations.google_calendar import disconnect_calendar
        disconnect_calendar()
